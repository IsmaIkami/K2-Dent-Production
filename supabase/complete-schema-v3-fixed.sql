...
-- Version: 3.0.1 FIXED
-- Description: Recréation COMPLÈTE du schéma DB - AJOUTE colonnes manquantes aux tables existantes
-- ============================================
...
-- ============================================
-- TABLE 3: APPOINTMENTS (ajouter colonnes start_time/end_time si manquantes)
-- ============================================
...
BEGIN
  ...
  RAISE NOTICE '   2. ✅ patients (colonnes médicales avancées ajoutées)';
  ...
  RAISE NOTICE '';
  RAISE NOTICE '═══════════════════════════════════════════════════════════';
  RAISE NOTICE 'TOUT EST PRÊT! Le frontend devrait maintenant fonctionner.';
  RAISE NOTICE '═══════════════════════════════════════════════════════════';
END $$;
