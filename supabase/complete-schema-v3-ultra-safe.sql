...
-- Version: 3.0.2 ULTRA SAFE
-- Description: Script 100% safe - vérifie CHAQUE colonne avant ajout
-- ============================================
...
-- ============================================
-- ÉTAPE 1: AJOUTER COLONNES MANQUANTES AUX TABLES EXISTANTES
-- ============================================

-- Ajouter colonnes manquantes à PATIENTS
DO $$
BEGIN
...
-- Ajouter colonnes manquantes à APPOINTMENTS
DO $$
BEGIN
...
-- ============================================
-- TABLE 7: DENTAL_CHARTS (DROP ET RECREATE si existe déjà)
-- ============================================
